...
public class ManageEnterpriseJPanel extends javax.swing.JPanel {
    ...
    private void populateTable() {
        ...
        for (Network network : system.getNetworkList()) {
            for (Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
                ...
                row[3] = enterprise.getOrgAddress();
                row[4] = enterprise.getOrgCountry();
                row[5] = enterprise.getOrgCity();
                row[6] = enterprise.getOrgZipCode();
    ...
    private void initComponents() {
        ...
        submitJButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/Icons/file_light-07-512-2.png"))); // NOI18N
        ...
        backJButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/Icons/icons/93634-2.png"))); // NOI18N
        ...
        btnDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/Icons/icons/delete-1432400-1211078-2.png"))); // NOI18N
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        for( Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
            if(enterprise.getOrgEmail().equals(tfEmail.getText())) {
                JOptionPane.showMessageDialog(null, "Email Address already exists");
            }
        }
        
        String OrgName = nameJTextField.getText();
        String OrgAddress = tfStreetAddress.getText();
        String OrgEmail = tfEmail.getText();
        String OrgCountry = tfCountry.getText();
        String OrgCity = tfCity.getText();
        Integer OrgZipCode = parseInt(tfZipcode.getText());
        String OrgPhone = tfPhoneNumber.getText();

        Enterprise enterprise = network.getEnterpriseDirectory().createAndAddEnterprise(OrgName,OrgAddress,OrgCity,OrgCountry,OrgZipCode,OrgEmail,OrgPhone,type);
